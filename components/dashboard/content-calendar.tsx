...
import { PostDetailsDialog } from './calendar/post-details-dialog';
import { ScheduledPost } from './calendar/types';
...
export function ContentCalendar() {
  const [selectedDate, setSelectedDate] = useState<Date>(new Date(2024, 3, 15)); // Set initial date to match mock posts
